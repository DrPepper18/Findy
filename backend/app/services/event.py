...
async def add_new_event(data: EventPostRequest, session: AsyncSession):
    """
...
async def register_join(event_id: str, user_email: str, session: AsyncSession):
    """
...
async def join_user_to_event(event_id: int, user_email: str, session: AsyncSession):
